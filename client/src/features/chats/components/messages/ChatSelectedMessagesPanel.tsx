...
import { CloseIcon, ReplyIcon, TrashIcon } from "@/shared/icons";
...
export function ChatSelectedMessagesPanel({
    ...
    return (
        <div className="w-full px-[15%] flex items-center gap-[10px] justify-center py-[15px] bg-transparent ">
            <div className="flex justify-between items-center gap-[100px] px-[20px] min-h-[48px] bg-white dark:bg-neutral-950 border border-neutral-300 dark:border-neutral-800 w-auto rounded-xl">
                <div className="flex gap-[20px] items-center">
                    <ButtonIcon onClick={handleClearSelect}>
                ...
                <div className="flex gap-[10px]">
                    <ButtonIcon onClick={handleForward}>
                        <ReplyIcon className="rotate-270 w-[23px] fill-none stroke-3 stroke-neutral-900 dark:stroke-white" />
                    </ButtonIcon>
                    {(chat.type === ChatEnum.PRIVATE ||
                        ...
                        <ButtonIcon onClick={handleDelete}>
                            <TrashIcon className="w-[23px] fill-none stroke-[2.5] stroke-red-600" />
                        </ButtonIcon>
                    )}
                </div>
            </div>
